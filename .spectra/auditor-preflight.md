...
**Finding:** The bridge architecture assumes Desktop's original registry value (at `/home/tomcat65/.claude/chrome/desktop-native-host-original.txt`) will always be valid. If:
...
**Location:** `/home/tomcat65/.claude/skills/chrome-wsl/SKILL.md`, lines 157-164 (`switch desktop` subcommand)
...
**Location:** `/home/tomcat65/.claude/skills/chrome-wsl/SKILL.md`, lines 222-228
...
- The .bat bridge: `C:\Windows\system32\wsl.exe --exec /home/tomcat65/.claude/chrome/chrome-native-host`
- The manifest path template: `/home/tomcat65/.claude/chrome/chrome-native-host`
...
2. WSL native host now at `/home/newmount/tomcat65/.claude/chrome/chrome-native-host`
3. .bat bridge still points to `/home/tomcat65/.claude/chrome/chrome-native-host`
...
**Location:** `/home/tomcat65/.claude/skills/chrome-wsl/SKILL.md`, lines 138-143 (`switch code` subcommand)
...
**Location:** `/home/tomcat65/.claude/skills/chrome-wsl/SKILL.md`, line 239
...
- Code manifest: `/mnt/c/Users/TOMAS/.claude/chrome/com.anthropic.claude_code_browser_extension.json`
- Desktop-override manifest: `/mnt/c/Users/TOMAS/.claude/chrome/com.anthropic.claude_browser_extension.json`
...
**Location:** `/home/tomcat65/.claude/chrome/chrome-native-host` (the wrapper script)

**Finding:** The wrapper is generated by Claude Code:
```bash
#!/bin/sh
exec "/home/tomcat65/.local/share/claude/versions/2.1.37" --chrome-native-host
```

If Claude Code is upgraded:
1. New version written to `/home/tomcat65/.local/share/claude/versions/X.Y.Z`
...
No `/home/tomcat65/projects/dev/chrome-wsl-bridge/.spectra/non-goals.md` exists yet. Recommend creating one to document:
...
```batch
@echo off
echo %DATE% %TIME% invoked >> "C:\Users\TOMAS\.claude\chrome\bridge.log"
C:\Windows\system32\wsl.exe --exec /home/tomcat65/.claude/chrome/chrome-native-host
```
